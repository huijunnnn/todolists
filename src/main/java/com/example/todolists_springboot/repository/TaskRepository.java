...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query(value = "SELECT t FROM Task t WHERE t.taskName LIKE %:keyword% AND t.taskCompleted=:completed")
    List<Task> findByTaskCompletedAndKeyword(Boolean completed, String keyword);
}
